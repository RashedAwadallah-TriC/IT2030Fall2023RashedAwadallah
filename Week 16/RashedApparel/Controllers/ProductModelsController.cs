...
namespace RashedApparel.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public ProductModelsController(RashedApparelContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.ProductDb != null ? 
                          ...
                          Problem("Entity set 'RashedApparelContext.ProductDb'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RashedApparelContext.ProductDb'  is null.");
            }
            var productModel = await _context.ProductDb.FindAsync(id);
            if (productModel != null)
            {
